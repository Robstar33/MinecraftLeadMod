...
public class ModPlacedFeatures {
    ...
    public static final RegistryObject<PlacedFeature> END_LEAD_ORE_PLACED = PLACED_FEATURES.register("end_lead_ore_placed",
            () -> new PlacedFeature(ModConfiguredFeatures.END_LEAD_ORE.getHolder().get(),
